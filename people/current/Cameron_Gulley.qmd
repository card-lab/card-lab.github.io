...
about:
  template: trestles
  image: ../../files/photos/People/anon.jpg
  image-alt: "Stock photo of a dog wearing glasses. (Unfortunately no photo of Cameron Gulley was available)"
  image-shape: round
  links:
    - text: "{{< iconify mdi linkedin >}}"
      url: https://www.linkedin.com/in/cameron-gulley-35653a144
