...
<div class="csl-entry" style="clear: left; ">
<div class="csl-left-margin" style="float: left; padding-right: 0.5em; text-align: right; width: 1em;">[1]</div><div class="csl-right-inline" style="margin: 0 .4em 0 1.5em;"><i>`mtex-grain-size` -- Functions for ASTM (and ISO) grain size characterization from electron backscatter diffraction (EBSD) data using the MTEX toolbox for MATLAB</i>. (Jul. 28, 2025). MATLAB. Zenodo, Cincinnati, OH, USA. doi: <a href="https://doi.org/10.5281/ZENODO.16541961.">10.5281/ZENODO.16541961.</a></div>
</div></div>
```
