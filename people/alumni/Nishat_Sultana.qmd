...
about:
  ...
  links:
    ...
    - text: "![Flag of Australia](https://flagcdn.com/au.svg){width=0.25in}"
    ...
    - text: "![Flag of New Zealand](https://flagcdn.com/nz.svg){width=0.25in}"
      url: https://en.wikipedia.org/wiki/New_Zealand
    - text: "![Flag of Bangladesh](https://flagcdn.com/bd.svg){width=0.25in}"
