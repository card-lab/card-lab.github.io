...
execute:
  echo: false
image: ../../files/photos/People/Zoey_Jestude.jpg
about:
  template: trestles
  image: ../../files/photos/People/Zoey_Jestude.jpg
  image-alt: "Photo of Zoey Jestude"
  image-shape: round
  links:
    ...
    - text: "![Flag of Massachusetts](https://flagcdn.com/us-ma.svg){width=0.25in}"
      url: https://en.wikipedia.org/wiki/Massachusetts

---

<!-- card-lab-authorship-name: Jestude, Z. -->


```{=html}
<div class="member-range-source" data-member-range="May 2024 to August 2024"></div>
<script>
