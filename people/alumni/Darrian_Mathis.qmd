...
member-from: 2026-01-15 00:00:00
...
execute:
  echo: false
image: ../../files/photos/People/Darrian_Mathis.jpg
about:
  template: trestles
  image: ../../files/photos/People/Darrian_Mathis.jpg
  image-alt: "Photo of Darrian Mathis"
  image-shape: round
  links:
    - text: "{{< iconify mdi linkedin >}}"
      url: https://www.linkedin.com/in/darrianjjmathis
...
<!-- card-lab-authorship-name: Mathis, D. J. J. -->


```{=html}
<div class="member-range-source" data-member-range="January 2026 to May 2025"></div>
<script>
