...
about:
  ...
  links:
    ...
    - text: "![Flag of Georgia](https://flagcdn.com/us-ga.svg){width=0.25in}"
      url: https://en.wikipedia.org/wiki/Georgia
    - text: "![Flag of Oklahoma](https://flagcdn.com/us-ok.svg){width=0.25in}"
...
<!-- card-lab-authorship-name: McMillen, A. T. -->
